...
- **起点基础**：
  ...
  - **关键认知特质（优势）**：逻辑抽象与本质理解能力极强（Cognitive+），一点就通，极度反感死记硬背，非常适合“底层原理解析 + 乐高积木拼装法”。
...
- **当前里程碑**：
  ...
  - [ ] **M2: 初中到实用核心 300 常用语块与生活动词实战积累** (进行中 ≈6%：已归档约 17 个语块 / 300)
  - [ ] **M3: 连续 30 天日常英文对话打卡**
...
- **🆕 M2 新增教学要点**：动词短语（`get up`）的 `-s` **只加在动词头上**，小副词/介词（`up`）是方向标签，永不参与人称变形（❌ `he get ups`）。
...
2. ⚠️ **M1 已全面通关，严禁重教**基础内容（两大门派 / `-ing` / 第三人称 `-s` / 否定 / 疑问）。直接进入 **M2 语块积累**。
3. **推荐接续课题**：
